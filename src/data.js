...
module.exports = [
  ...
  },
  {
    name: 'Scott Spence',
    description:
      'Web Developer • JAMstack advocate / champion / evangelist / herald • One half of @WskyWednesday with @themarcba • JavaScript • React • Gatsby • Toast • GraphQL',
    url: 'https://ss10.dev/uses',
    twitter: '@spences10',
    emoji: '🙃',
    country: '🇬🇧',
    computer: 'linux',
