...
module.exports = [
  ...
  },
  {
    ...
    description: 'Web developer and connoisseur of minimalism',
    url: 'https://www.rubenarakelyan.uk/uses/',
    country: '🇬🇧',
    emoji: '💾',
    computer: 'apple',
    phone: 'iphone',
  ...
  {
    name: 'Eosis',
    description: 'CS Student from France',
    url: 'https://eosis.codes/uses',
