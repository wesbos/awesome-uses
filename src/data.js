...
module.exports = [
  ...
  },
  {
    name: 'Noha Fahmi',
    description:
      'Front-end developer who loves building great and beautiful things from scratch through coding, also can do some backend stuff too.',
    url: 'https://nohafahmi.com/uses/',
    twitter: '@nohafahmi',
    emoji: '👩‍💻💻opy',
    country: '🇪🇬',
    computer: 'windows',
